      ...
      <section className="panel">
        ...
        <div className="bg-[url(/images/whitegradient.jpg)]">
          ...
          <ol>
            ...
            <li>
              On your local computer, open a brand new VS Code window. Click on the
              version control tab on the left-hand side (it looks like a branch). 
              {' '}
            </li>
            {' '}
            <li>
               Click on the "clone repository" button. It should prompt you to log in.
              Pick the repository you want to clone. {' '}
            </li>
            {' '}
            ...
            {' '}
            <li>
              Run the development server: <br /><code>npm run dev</code>
              {' '}
            </li>
            {' '}
          </ol>
          ...
          <p className="body-text">
            Note that because this is a React App, you will have to navigate to yourResume / Portfolio Tips
            
            portfolio on the command line and run <code>npm run dev</code> in order to see
            your changes in the browser. {' '}
          </p>
          <h3 className="h3-underlined">Using Tailwind CSS & React</h3>{' '}
          <p className="body-text">
            Tailwind is a mobile-first CSS framework that allows you to build complex
            designs by combining simple, predefined classes together (just like combo
            classes in Webflow). It's a great way to get started with CSS and to build
            responsive designs. {' '}
          </p>
          {' '}
          <ul>
            ...
            <li>
             {' '}
              <a
                ...
                target="_blank"
              >
               Visual design 101: How to develop your own look and feel while
